...
@Configuration
@EnableSwagger2
@ComponentScan(basePackages = "com.apache.camel")
public class SwaggerConfig {
	...
	private Predicate<String> paths() {
		return regex("/rootCamel/.*");
	}

	@SuppressWarnings("deprecation")
	private ApiInfo apiInfo() {
		return new ApiInfo("OSB Proxy Conversion Service", "Converting Simple OSB proxy into Apache Camel ", "1.0",
